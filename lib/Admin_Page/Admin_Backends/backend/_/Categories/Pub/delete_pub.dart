...
class _DeletePageState extends State<DeletePage> {
    ...
    if (response.statusCode == 200) {
      ...
      return data.map<Map<String, String>>((imageJson) {
        return {
          'id': imageJson['id'] ?? '',
          'data': imageJson['data'] ?? '',
          'imageName': imageJson['imageName'] ?? 'Unknown Name',
          ...
          'website': imageJson['website'] ?? 'No website available', // Added website
        };
      }).toList();
    } else {
  ...
  Future<void> _deleteImage(String id) async {
    final response = await http.delete(
      Uri.parse('https://pubnodejs.onrender.com/delete/$id'),
    );
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final website = imageData['website'] ?? 'No website available'; // Display website
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text('Website: $website', style: TextStyle(color: Colors.purple)), // Added website display
                      ],
                    ),
                    trailing: IconButton(
