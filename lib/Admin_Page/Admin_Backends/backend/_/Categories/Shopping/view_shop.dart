...
class ReadShopImage extends StatefulWidget {
  @override
  _ReadImageState createState() => _ReadImageState();
}

class _ReadImageState extends State<ReadShopImage> {
  ...
  void _filterImages(String query) {
    List<Map<String, String>> filteredList = _allImageDataList.where((imageData) {
      return imageData['imageName']!.toLowerCase().contains(query.toLowerCase()) ||
          ...
          IconButton(
            onPressed: () {
              setState(() {
                ...
                if (!_isSearching) {
                  _searchController.clear(); // Clear search text when exiting search mode
                }
              });
            },
              ...
              FutureBuilder<List<Map<String, String>>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(child: Text('Search by any another'));
                  } else {
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        Map<String, String> imageData = _filteredImageDataList[index];
