...
class EditImagePage extends StatefulWidget {
  ...
  final String currentWebsite; // Added website field
  ...
  EditImagePage({
    ...
    required this.currentWebsite, // Pass website as parameter
  });
...
class _EditImagePageState extends State<EditImagePage> {
  ...
  TextEditingController _websiteController = TextEditingController(); // Controller for website
  ...
  void initState() {
    ...
    _websiteController.text = widget.currentWebsite; // Set initial value for website
  ...
  Future<void> _updateImage() async {
    ...
    String website = _websiteController.text; // Get website input
    ...
    request.fields['website'] = website; // Add website field to request
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pop(context, {
          ...
          'phoneNo1': phoneNo1,
          'phoneNo2': phoneNo2,
          'website': website, // Return website field in response
        });
      } else {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              TextField(
                controller: _websiteController, // Add website field to form
