...
class ReadTempleImage extends StatefulWidget {
  @override
  _ReadImageState createState() => _ReadImageState();
}

class _ReadImageState extends State<ReadTempleImage> {
  ...
  bool _isSearching = false; // Flag to track if search mode is on

  // Function to fetch image data from the backend
  Future<List<Map<String, String>>> fetchImageData() async {
    final response =
    await http.get(Uri.parse('PLACE YOUR URL'));
              ...
              FutureBuilder<List<Map<String, String>>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    // Shimmer effect when data is being fetched
